  ...
  return (
   <div className="firstpageanim">
    <div className="relative h-screen w-screen flex flex-col items-center justify-center text-white overflow-hidden">
      ...
      {/* Login Box */}
      <div className="bg-white/10 backdrop-blur-md text-black px-10 py-4 rounded-3xl shadow-xl
        w-[450px] sm:w-[500px] z-10 mt-4">
        ...
        <form className="flex flex-col space-y-2">
          ...
          />
          <button className="bg-cyan-600  w-50 mx-auto text-white p-2 rounded hover:bg-cyan-400 transition">
            🌙 Open My Diary
          </button>
